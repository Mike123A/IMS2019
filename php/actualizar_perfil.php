...
<body>
	...
	if (isset($_POST['Guardar'])) {
		...
		include("conexion.php");
		$sql="SELECT * FROM cat_clientes cc INNER JOIN cat_usuarios cu ON cc.idUsuario = cu.idUsuario WHERE cc.idUsuario=".$clave.";";
...
?>
	<section class="ContenedorPrincipal">
		...
		<h1>Esta es tu informacion, puedes actualizarla si deseas.</h1>
			...
			<br> 	<br>	
			<a href="../"><input id="btn_cancelar" type="button" value="Cancelar" name="Cancelar"></a>
