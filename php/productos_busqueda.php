...
<body>
	...
	<section class="ContenedorPrincipal">
		...
		<?php
				...
				$sql_numr = mysqli_query($conexion,"SELECT COUNT(*) as total FROM cat_productos WHERE (NombreProd LIKE '%$busqueda%' OR DescripcionProd LIKE '%$busqueda%' ) AND estado = 'Alta'");
				...
				$sql = "SELECT * FROM cat_productos WHERE (NombreProd LIKE '%$busqueda%' OR DescripcionProd LIKE '%$busqueda%' ) AND estado = 'Alta'";
