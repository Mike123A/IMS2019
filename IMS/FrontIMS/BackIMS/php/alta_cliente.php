...
<body>
	...
	<section class="ContenedorPrincipal">
		...
		<h1>Alta de cliente</h1>
			...
			<input type="tel" required name="Telefono" placeholder="<?php if(isset($telefono) && $telefono ==''){ echo 'Intente con otro';}else{echo 'Aqui va el telefono';}?>" value="<?php if(isset($telefono)) {echo $telefono;}?>"  pattern="[0-9]+" maxlength="10" /><br>
			<label>RFC</label><br>
