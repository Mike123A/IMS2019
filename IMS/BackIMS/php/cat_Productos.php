			...
			<?php
				...
				while($fila = $resultado->fetch_assoc()){
					...
					<tr>
						...
						<td><a href='cambios_distribuidor.php?clave=".$fila['idDistribuidor']."'>Modificar</a></td>
						<td><a href='eliminar_distribuidor.php?clave=".$fila['idDistribuidor']."'>Eliminar</a></td>
					</tr>";
